                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                <div class="member-card pt-2 pb-2">
                                    ...
                                    <div class="text-center"><a class="btn btn-primary" href="../patient/patientCprofile.php">Profile</a></div>
                                    <br>
                                    <div class="text-center"><a class="btn btn-primary" href="../patient/patientAppointment.php">Set Appointment</a></div>
                                    <div class="mt-4">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="mt-3">
                        ...
                        <div class="col-lg-4">
                            <div class="text-center card-box">
                                <div class="member-card pt-2 pb-2">
                                    ...
                                    <div class="text-center"><a class="btn btn-primary" href="../patient/patientCprofile.php">Profile</a></div>
                                    <br>
                                    <div class="text-center"><a class="btn btn-primary" href="../patient/patientAppointment.php">Set Appointment</a></div>X`
                                    <div class="mt-4">
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="mt-3">
